        ...
        <header>
            <div className="header-content">
                <div className="logo-container">
                    <img src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/9d2545bd-49a2-4c6d-b3d3-0a13b69d7277" alt="Shield Icon" className="shield-icon"/>
                ...
                <button className="theme-toggle" id="theme-toggle" aria-label="Alternar tema">
                    ...
                    <svg className="moon-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{display: "none"}}>
                ...
                <div className="evidence-container">
                    ...
                    <div className="upload-area">
                        <div className="upload-instructions">
                            ...
                            <button className="select-files-button">Selecionar arquivos</button>
                        </div>
                        <input type="file" id="file-upload" className="file-upload" multiple />
                        <p className="supported-formats">Formatos suportados: PNG, JPG, PDF, DOC</p>
                    </div>
                    ...
                    <button className="submit-case-button" id="submit-case">Enviar Caso</button>
                    <p className="data-security">Seus dados são seguros e confidenciais.</p>
                </div>
            </section>
            ...
            <section className="review-process-section">
                <div className="review-process-container">
                    <div className="review-process-nav">
                        <button className="nav-button active">Como funciona o processo de revisão?</button>
                        <button className="nav-button">Seus direitos</button>
                        <button className="nav-button">O que acontece após o envio?</button>
                    </div>
            ...
            <div className="footer-container">
                <div className="footer-content">
                    ...
                    <button className="report-button">
                        ...
                        <img src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/12394095-55c4-46fa-9768-1571b7b0403d" alt="Report icon" className="report-icon"/>
                    </button>
                </div>
            </div>
        </footer>
